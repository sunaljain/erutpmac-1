angular.module('app', ['ionic','ngCookies','ngAutocomplete','ngCordova','ion-google-place','app.routes', 'app.services', 'app.headerbar', 'app.login', 'app.feed', 'app.profile', 'app.trip', 'app.addTrip'])
